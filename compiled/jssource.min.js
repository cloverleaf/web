...
var mode = void 0;
var date = new Date();
var cookieCrumble = new Date(date.getFullYear() + 1, date.getMonth(), date.getDate()); // Make a date 1 year into THE FUTURE
...
var targetLength = 16;
var side = void 0; // Side nav
var select = void 0; // Theme selector
...
function checkDebug() {
	if (debugMode) {
		...
		var css = "a[id=testTheme]{background-color: #ff00ff !important; border: 1px ;}a[id=testTheme] i {color: #ff00ff";
...
function getQueryStrings() {
	...
	keyValues.forEach(function (product) {
...
window.copy = function () {
	...
	var pass = document.getElementById("result").value;
...
function process() {
	...
	var regex = void 0; // Blank for the same reason
	var appName = document.getElementById("app").value.trim();
...
function setLogo(appName) {
	...
	switch (_typeof(jsonData[appName].mini)) {
		...
		default:
			throw new Error("Invalid mini value \"" + _typeof(jsonData[appName].mini) + "\" for " + jsonData[appName] + " preset");
...
window.onload = function () {
	...
	// Initialize the tabs
	var tabs = M.Tabs.init(document.querySelectorAll(".tabs"))[0];
...
function colourUnderline() {
	...
	if (document.getElementById("pass").value) {
		...
		var colour = "HSL(" + getRandomArbitrary(0, 360) + ", " + getRandomArbitrary(60, 100) + "%, " + getRandomArbitrary(45, 80) + "%)";
