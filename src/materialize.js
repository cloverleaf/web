    ...
    _createClass(Autocomplete, [{
      ...
      value: function _renderDropdown(data, val) {
        ...
        if (this.options.customSort) {
          var customResult = this.options.customSort(data, val.toLowerCase());
          ...
          if (Array.isArray(customResult)) {
            ...
            console.error('customSort should return an array objects. For more info see https://materializecss.github.io/materialize/autocomplete.html');
          }
        } else {
          ...
          if (this.options.compareFunction) {
            var compareFunctionBound = function (a, b) {
              return _this39.options.compareFunction(a.key.toLowerCase(), b.key.toLowerCase(), val.toLowerCase());
            };
